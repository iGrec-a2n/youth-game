...
def get_score():
    ...
    # Si un pays est spécifié, on récupère les utilisateurs correspondants
    if pays_recupere:
        pays_recupere = pays_recupere  # Assure-toi que le pays est capitalisé
        
        # Recherche des utilisateurs avec le pays spécifié
        ...
        # Récupérer les scores des utilisateurs correspondants
        scores = []
